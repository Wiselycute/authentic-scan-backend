const buildAuthentiScanPrompt = ({ ocrText = '', barcode = '', qrCode = '', productName = '', brandName = '' }) => {
  return [
    ...
    'Extract probable productName, brandName, category, manufacturer, countryOfOrigin, and ingredients from packaging text and visual evidence when possible.',
    'If extraction is uncertain, return empty strings for text fields and [] for ingredients.',
